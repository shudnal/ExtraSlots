...
{
    // Equipment-panel dragging only. Hotbar positions are configured through their offsets/anchors.
    internal static class UIDragging
    {
        internal sealed class DragHandle : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
        {
            ...
            public void OnBeginDrag(PointerEventData eventData)
            {
                ...
                movementSpace = transform.parent as RectTransform;
            ...
            public void OnDrag(PointerEventData eventData)
            {
                ...
                rawPosition += delta;
                previewPosition = SnapPosition != null ? SnapPosition(rawPosition) : rawPosition;
